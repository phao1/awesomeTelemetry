...
- [ ] 3.1 全局头 48px + underline tabs 40px + 三栏 + 状态栏 28px
- [ ] 3.2 左右栏拖拽调宽（rail 260–480、inspector 280–900）与折叠
- [ ] 3.3 状态栏：连接态（`aria-live`）/ 会话与事件计数 / 扫描态 / 库大小 / 数据源标识
- [ ] 3.4 布局偏好持久化（REQ-026 的 7 个键），读取时做范围校验
